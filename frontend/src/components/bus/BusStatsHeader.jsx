    ...
    <div className="rounded-card bg-surface-alt dark:bg-surface-dark-alt border border-line dark:border-line-dark p-3.5 mb-4">
      <div className="flex items-end justify-between mb-2.5 gap-3">
        <div className="min-w-0">
          <div className="text-label text-mute dark:text-mute-dark font-semibold tracking-wide mb-0.5 flex items-center gap-1.5">
            <span>평소 배차 간격</span>
            {isLowSample && (
        ...
        {subtitle && (
          <span className="text-caption text-mute dark:text-mute-dark shrink-0 pb-0.5">{subtitle}</span>
        )}
      </div>
      <ArrivalDistributionBar
        ...
        variant="full"
      />
      <div className="mt-2 flex items-center justify-between text-caption text-mute dark:text-mute-dark">
