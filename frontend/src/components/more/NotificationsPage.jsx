  ...
  return (
    <div className="flex flex-col h-full bg-bg dark:bg-bg animate-slide-in-right">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 pb-28 md:pb-6 flex items-center justify-center">
        <div className="bg-surface dark:bg-surface rounded-card shadow-card px-7 py-8 max-w-xs w-full flex flex-col items-center gap-3.5 text-center">
          <div className="w-14 h-14 rounded-card bg-chip-yellow-bg dark:bg-chip-yellow-bg flex items-center justify-center text-chip-yellow-fg dark:text-chip-yellow-fg">
            <Construction size={26} strokeWidth={1.8} />
          </div>
          <div>
            <p className="text-panel-ttl text-ink dark:text-ink">개발 중</p>
            <p className="text-meta font-semibold text-mute dark:text-mute mt-1.5 leading-relaxed">
