...
INSERT INTO bus_stop_routes (bus_stop_id, bus_route_id) VALUES (3, 1);
...
INSERT INTO map_marker_routes (id, marker_id, route_number, route_color, badge_text, outbound_stop_id, inbound_stop_id, ui_meta, sort_order) VALUES (1, 5, '3400', '#DC2626', 'G', 3, 6, '{"spineLeft": "시화", "spineRight": "강남", "inboundSegment": "정왕행", "inboundDirLabel": "강남 → 학교행", "outboundSegment": "서울행", "outboundDirLabel": "학교 → 강남행", "inboundActiveSide": "left", "outboundActiveSide": "right"}', 0);
