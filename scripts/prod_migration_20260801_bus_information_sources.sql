...
FROM (VALUES
  ...
  ('시흥33','하교','to-siheung-city-hall','realtime','boarding_arrival','224000639','한국공학대학교 도착','to-city-hall',10),
  ('99-2','하교','to-wolgot','realtime','boarding_arrival','224000861','시흥터미널 도착','to-wolgot',10),
  ('99-2','하교','to-wolgot','realtime','boarding_arrival','224000513','이마트 도착','to-wolgot',20),
