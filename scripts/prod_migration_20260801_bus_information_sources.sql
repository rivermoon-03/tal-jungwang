...
FROM (VALUES
  ...
  ('99-2','하교','to-wolgot','시흥터미널·이마트','월곶역','["시흥터미널","이마트","월곶역"]',10),
...
FROM (VALUES
  ('3400','하교','to-seoul','timetable','departure','224000861','시흥터미널 승차','to-seoul',10),
  ('3400','하교','to-seoul','realtime','boarding_arrival','224000513','이마트 승차','to-seoul',20),
  ('3401','하교','to-seoul','timetable','departure','224000513','이마트 승차','to-seoul',10),
  ('3401','하교','to-seoul','realtime','downstream_arrival','224000538','시흥시청 도착','to-seoul',20),
  ('3401','하교','to-siheung-city-hall','timetable','departure','224000513','이마트 승차','to-seoul',10),
  ('3401','하교','to-siheung-city-hall','realtime','downstream_arrival','224000538','시흥시청 도착','to-seoul',20),
  ('5602','하교','to-seoul','timetable','departure','224000513','이마트 승차','to-seoul',10),
  ('5602','하교','to-seoul','realtime','downstream_arrival','224000538','시흥시청 도착','to-seoul',20),
  ('5602','하교','to-siheung-city-hall','timetable','departure','224000513','이마트 승차','to-seoul',10),
  ('5602','하교','to-siheung-city-hall','realtime','downstream_arrival','224000538','시흥시청 도착','to-seoul',20),
  ('6502','하교','to-seoul','timetable','departure','224000513','이마트 승차','to-seoul',10),
  ('5200','하교','to-seoul','realtime','boarding_arrival','224000861','시흥터미널 승차','to-seoul',10),
  ('5200','하교','to-seoul','realtime','boarding_arrival','224000513','이마트 승차','to-seoul',20),
  ('시흥1','하교','to-seoul','realtime','boarding_arrival','224000513','이마트 승차','to-seoul',20),
  ('11-A','하교','to-jeongwang','realtime','boarding_arrival','224000639','한국공학대학교 승차','to-jeongwang',10),
  ('20-1','하교','to-jeongwang','timetable','departure','224000639','한국공학대학교 승차','to-jeongwang',10),
  ('20-1','하교','to-jeongwang','realtime','boarding_arrival','224000639','한국공학대학교 승차','to-jeongwang',20),
  ('시흥33','하교','to-jeongwang','realtime','boarding_arrival','224000639','한국공학대학교 승차','to-city-hall',20),
  ('시흥33','하교','to-siheung-city-hall','realtime','boarding_arrival','224000639','한국공학대학교 승차','to-city-hall',10),
  ('99-2','하교','to-wolgot','realtime','boarding_arrival','224000861','시흥터미널 승차','to-wolgot',10),
  ('99-2','하교','to-wolgot','realtime','boarding_arrival','224000513','이마트 승차','to-wolgot',20),
  ('3400','등교','from-seoul','timetable','departure',NULL,'강남역 승차','from-seoul',10),
  ('3401','등교','from-seoul','timetable','departure',NULL,'석수역 승차','from-seoul',10),
  ('5602','등교','from-seoul','timetable','departure',NULL,'구로디지털단지역 승차','from-seoul',10),
  ('6502','등교','from-seoul','timetable','departure',NULL,'사당역 승차','from-seoul',10),
  ('3401','등교','from-siheung-city-hall','realtime','boarding_arrival','224000586','시흥시청 승차','from-city-hall',10),
  ('5602','등교','from-siheung-city-hall','realtime','boarding_arrival','224000586','시흥시청 승차','from-city-hall',10),
  ('시흥33','등교','from-siheung-city-hall','realtime','boarding_arrival','224000586','시흥시청 승차','from-city-hall',10)
...
FROM (VALUES
  ...
  ('99-2','하교','224000861','to-wolgot'),
  ('99-2','하교','224000513','to-wolgot'),
